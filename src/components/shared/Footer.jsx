      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">@HireMee</h2>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com/NAVEEN9044" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/naveen-kumar-aven/" className="hover:text-gray-400" aria-label="LinkedIn">
